...
import '../actors/actors_list_page.dart';
      ...
      child: ElevatedButton(
        ...
        onPressed: () => {
          http.get(Uri.parse('http://localhost:3000/movies')).then((allMovies) {
            http
                .get(Uri.parse('http://localhost:3000/movie/preferences/' +
                    userId.toString()))
                .then((prefMovies) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      MovieListPage(jsonEncode(movies), true, userData),
                ),
              );
            });
          }),
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        http.get(Uri.parse('http://localhost:3000/actors')).then((allActors) {
          http
              .get(Uri.parse('http://localhost:3000/actor/preferences/' +
                  userId.toString()))
              .then((prefActors) {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    ActorListPage(jsonEncode(actors), true, userData),
              ),
            );
          });
        });
